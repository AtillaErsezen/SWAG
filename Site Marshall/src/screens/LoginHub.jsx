...
const LoginHub = () => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex flex-col" style={{ backgroundColor: '#0D1B2A' }} onClick={() => setLangOpen(false)}>
            <div className="flex-1 flex flex-col items-center px-5 gap-5 overflow-y-auto pt-6 pb-8">
                
                {/* Language Picker (in flow, scrolls with content, guaranteed no overlap) */}
                        ...
                        <AnimatePresence>
                            {langOpen && (
                                <motion.div initial={{ opacity: 0, y: 6, scale: 0.95 }} animate={{ opacity: 1, y: 0, scale: 1 }}
                                    ...
                                    className="absolute top-full right-0 mt-2 bg-white rounded-2xl shadow-2xl border border-gray-100 overflow-hidden min-w-36 z-[9999]">
